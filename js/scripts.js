$(document).ready(function () {
  ...
  var myCalendar = createCalendar({
    ...
    data: {
      // Event title
      title: "Zheng Mu and Yeu Jean's Wedding",

      // Event start date
      start: new Date("Dec 07, 2025 18:00"),
      ...
      end: new Date("Dec 07, 2025 21:00"),

      // Event Address
      address: "Restoran SY (Sam Choon), Batu Bahat",

      // Event Description
      description:
        "We can't wait to see you on our big day. For any queries or issues, please contact Yeu Jean at +60 10-903 4088.",
    },
  });
  ...
  function getWeddingDateFromNow() {
    return new Date("Dec 07, 2025 18:00");
  }
  ...
  $("#rsvp-form").on("submit", function (e) {
    ...
    if (
      ...
      $.post(
        "https://script.google.com/macros/s/AKfycbwXMei5jyIAq6EH1SXubjucxjvH8RxqHNEgLyx2TyxpDbYf1Q7pttYTq9xeda6GQgLt/exec",
        data
      )
        .done(function (data) {
          console.log(data);
